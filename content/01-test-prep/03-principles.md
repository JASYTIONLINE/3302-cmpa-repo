...
![image of pillars of pmi principles](principles.png)
*A PMP Exam Knowledge Base Resource*

---
## What this page is about  

This page explains PMI’s 12 **Project Management Principles** — a foundational component of the [PMP exam](https://www.pmi.org/certifications/project-management-pmp) and the [[2-references.md|PMBOK® Guide – Seventh Edition.]] These principles provide the mindset and ethical compass for how projects should be led, regardless of delivery method ([[3-glossary#predictive|Predictive]], [[3-glossary#agile|Agile]], or [[3-glossary#hybrid|Hybrid]]).  
...
- You ensure formal [[3-glossary#acceptance|acceptance]] of deliverables (Principle 1 – Stewardship).  
- You use a [[3-glossary#RACI|RACI matrix]] to clarify roles, ensuring team collaboration (Principle 2).  
...
- You focus on incremental [[3-glossary#value delivery|value delivery]] through both documented plans and iterative cycles (Principle 4).  
- You manage [[3-glossary#risk management|risk]] by combining qualitative matrices with sprint-based feedback (Principle 10).  
