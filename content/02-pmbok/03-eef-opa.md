...
Every project is launched into a world already in motion. That world includes policies, politics, systems, templates, bandwidth issues, loud departments, and yes — the company culture no one talks about but everyone feels. [[3-glossary#pmi|PMI]] gives you two big buckets for sorting that chaos: **[[3-glossary#enterprise-environmental-factors|Enterprise Environmental Factors (EEFs)]]** and **[[3-glossary#organizational-process-assets|Organizational Process Assets (OPAs)]]**.
...
**[[3-glossary#enterprise-environmental-factors|Enterprise Environmental Factors]]** are the environmental conditions that shape — or shake — your project. They live inside and outside the organization. Some are helpful. Some are frustrating. Many are both.

You can’t control them, but you *must* account for them.

Think:
- Company culture, [[3-glossary#leadership|leadership styles]], hierarchy norms  
- Industry regulations, labor laws, safety codes  
- Geographic challenges, climate, infrastructure  
- Availability of [[3-glossary#resources|resources]], tools, technology  
- Organizational appetite for [[3-glossary#risk|risk]], change, or experimentation  
- Political climate (internal and external)

An EEF doesn’t care whether your plan is perfect. It influences your plan anyway.

PMI calls these *[[3-glossary#inputs|inputs]]*. That’s the technical term. But in practice, they’re **real-world context** that you’d ignore at your peril.

---

### What are OPAs?

**[[3-glossary#organizational-process-assets|Organizational Process Assets]]** are your *internal toolbox*. These are the [[3-glossary#processes|processes]], policies, knowledge bases, and [[3-glossary#artifacts|artifacts]] your organization has built up over time.

You *can* influence them. You can also learn from them — if you bother to look.

Examples:
- [[3-glossary#templates|Templates]], checklists, style guides  
- Project closure procedures  
- Historical [[3-glossary#lessons-learned|lessons learned]] and retrospectives  
- [[3-glossary#risk-register|Risk registers]] from past efforts  
- [[3-glossary#change-control|Change control]] processes  
...
On the [[3-glossary#pmp|PMP exam]], you won’t get asked to recite the definition. PMI wants to see whether you can:
- Choose the right asset or input at the right time  
- Adjust your [[3-glossary#process|process]] based on environment  
...
For example:
- You’re creating a [[3-glossary#communication-plan|communication plan]]. Is there a template you should use? (OPA)  
- You’re deploying in multiple countries with different compliance laws. What influences your [[05-tailoring|tailoring]]? (EEF)  
- Your project team is fully remote. How does that affect scheduling, engagement, and deliverables? (EEF)  
- You’re preparing for a post-mortem. Where should you store the [[3-glossary#lessons-learned|lessons learned]]? (OPA)  
...
In [[3-glossary#predictive|predictive]] environments, you may see EEFs locked into formal policies. OPAs will show up as document templates and required reports.

In [[3-glossary#agile|agile]]? The lines blur. Maybe the retrospective format is an OPA. Maybe the team’s culture of daily standups is an internal EEF. You’ll see overlaps — and your job is to **stay aware**, not get rigid.

Both EEFs and OPAs are central to:
- [[03-lifecycle/index|Lifecycle stage decisions]]  
- [[04-ittos/index|Process tailoring]]  
- [[02-risk|Risk awareness]]  
- [[01-stakeholder|Stakeholder engagement]]  
- [[05-tailoring|Governance and adaptation strategies]]  

For background, see *PMBOK 6* and *PMBOK 7* in [[2-references.md|References]].
...
Start asking:
- What [[3-glossary#resources|resources]] are already available?  
- Who decided this [[3-glossary#process|process]] was “standard” — and why?  
- What can’t we change — and who set those limits?  
- What’s considered acceptable [[3-glossary#communication|communication]] here — and what’s just not done?  
...
- How do [[3-glossary#agile|agile]] teams balance flexible processes with formal assets?  
...
For practical application, see case studies in [[2-references.md|References]].
